...
public class GaitAssessmentPanel extends BaseAssessmentPanel {

	private static final String TAG = GaitAssessmentPanel.class.getSimpleName();

	private MovingObject target;
	
	public GaitAssessmentPanel(Context context, MovingObject o) {
		super(context);
		this.target = o;
	}
