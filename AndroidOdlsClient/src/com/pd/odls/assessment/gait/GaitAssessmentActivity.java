...
public class GaitAssessmentActivity extends BaseAssessmentActivity {
	...
	private ByteArrayOutputStream bufferAcc = new ByteArrayOutputStream();  //create the buffer to store 20 s test data at 5Hz
	private ByteArrayOutputStream bufferOri = new ByteArrayOutputStream();  //create the buffer to store 20 s test data at 5Hz
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MSG_BUFFER_FULL:
				...
				showDialog(GaitAssessmentActivity.DLG_BUFFER_FULL);
				...
				try {
					...
					Log.e(GaitAssessmentActivity.class.getCanonicalName(), e.getMessage());
				}
				break;
			case MSG_COUNT_DOWN:
				if(msg.arg1 > 0) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		testPanel = new GaitAssessmentPanel(this, mo);
