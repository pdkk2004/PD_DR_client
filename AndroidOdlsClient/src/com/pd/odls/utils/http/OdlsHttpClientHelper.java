package com.pd.odls.utils.http;
...
public class OdlsHttpClientHelper{
	...
	/**
	 * Performs an HTTP Post request to the specified url with the
	 * specified HttpEntity, and return the HttpResponse directly. 
	 * @param url
	 * @param params
	 * @return HttpResponse
	 * @throws Exception
	 */
	public static HttpResponse getHttpPostResponse(String url, HttpEntity entity) throws Exception {
		HttpResponse response = null;
		try {
			HttpClient client = getHttpClient();
			HttpPost request = new HttpPost(url);
