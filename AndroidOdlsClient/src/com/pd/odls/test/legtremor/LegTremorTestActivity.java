...
public class LegTremorTestActivity extends BaseTestActivity {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MSG_BUFFER_FULL:
				...
				showDialog(LegTremorTestActivity.DLG_BUFFER_FULL);
				...
				try {
					...
					Log.e(LegTremorTestActivity.class.getCanonicalName(), e.getMessage());
				}
				break;
			case MSG_COUNT_DOWN:
				if(msg.arg1 > 0) {
					LegTremorTestActivity.this.countDownDlg.setMessage(
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		testPanel = new LegTremorTestPanel(this, mo);
		...
		controlBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(isRunning == false) {
					initializeTest();
					Timer t = new Timer();
					countDownDlg = ProgressDialog.show(LegTremorTestActivity.this, "Ready... Test will begin in", 
...
//	}
	...
	protected void initializeTest() {
		...
		if(testThread == null || testThread.getState() == State.TERMINATED) {
			testThread = new LegTremorTestThread(testPanel, 
					testPanel.getHolder(), 
					dout,
					this, 
					handler);	
...
//					pauseOrResume();
					...
					timer.cancel();
					controlBtn.setText("Start");
					LegTremorTestActivity.this.leave();
				}
			})
			.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
