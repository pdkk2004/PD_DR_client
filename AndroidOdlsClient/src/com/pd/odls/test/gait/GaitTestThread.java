...
public class GaitTestThread extends BaseTestThread {
	
	private static final String TAG = GaitTestThread.class.getSimpleName();
...
//	private Accelerometer accelerometer;
	...
	public GaitTestThread(BaseTestPanel testPanel,
	...
	private AccelerometerDelegate delegate = new AccelerometerDelegate() {
		...
		public void onAccelerationChanged(float x, float y, float z) {
			...
			if(dout.size() >= 3 * 4 * 5 * 1000)
				handler.sendEmptyMessage(GaitTestActivity.MSG_BUFFER_FULL);				
		}
