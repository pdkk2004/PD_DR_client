...
public class FingerTappingTestPanel extends BaseTestPanel {

	private static final String TAG = FingerTappingTestPanel.class.getSimpleName();
	...
	public FingerTappingTestPanel(Context context, MovingObject o) {
		super(context);
		this.target = o;
	}
